...
- (instancetype)init {
    ...
    if (self) {
        JUNAppearanceSettings* appearanceSettings = [[JUNAppearanceSettings alloc] init];
        self.hb_appearanceSettings = appearanceSettings;
        self.enableSwitch = [[UISwitch alloc] init];
        self.enableSwitch.onTintColor = [UIColor colorWithRed: 0.21 green: 0.47 blue: 0.62 alpha: 1.00];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/JuinPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/JuinPrefs.bundle/Banner.png"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed: 0.94 green: 0.68 blue: 0.55 alpha: 1.00];
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Juin.disabled"]) return;
    [[self enableSwitch] setEnabled:NO];

    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Juin"
	message:@"Juin Preferences disabled due to Juin being disabled with iCleaner Pro"
...
- (void)toggleState {
    ...
    NSString* path = [NSString stringWithFormat:@"/var/mobile/Library/Preferences/love.litten.juinpreferences.plist"];
    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfFile:path];
    NSSet* allKeys = [NSSet setWithArray:[dictionary allKeys]];
    HBPreferences* preferences = [[HBPreferences alloc] initWithIdentifier: @"love.litten.juinpreferences"];
    
    if (!([[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.juinpreferences.plist"])) {
        enabled = YES;
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Juin"
